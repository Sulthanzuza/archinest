...
// Floating WhatsApp Button Component (MAIN EXPORT)
...
// Default export for backward compatibility (remove WhatsAppDemo if not needed)
const WhatsAppDemo = () => <div>Demo removed</div>;
